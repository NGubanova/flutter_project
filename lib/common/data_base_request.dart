abstract class DataBaseRequest {
  ...
  static const String _createTableUser =
      'CREATE TABLE "$tableUser" ("id" INTEGER,"phone" TEXT NOT NULL UNIQUE,"login" TEXT NOT NULL UNIQUE,"password" TEXT NOT NULL, "id_role" INTEGER NOT NULL, PRIMARY KEY("id" AUTOINCREMENT), FOREIGN KEY("id_role") REFERENCES "Role"("id"))';
